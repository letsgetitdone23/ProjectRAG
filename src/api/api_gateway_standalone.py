"""
Standalone API Gateway for Multi-thread RAG Service
    ...
    async def process_chat_request(self, request: ChatRequest) -> ChatResponse:
        ...
        try:
            ...
            mock_responses = {
                ...
                "process_downloads": "You can download capital gains statements through the AMC website or CAMS portal."
            }
    ...
    async def get_service_stats(self) -> Dict:
        ...
        try:
            ...
            return {
                ...
                "capabilities": {
                    "question_types": [
                        "nav", "expense_ratio", "exit_load", "minimum_sip",
                        "elss_lockin", "riskometer", "benchmark", "process_downloads"
                    ],
                    "validation": {
                        "multi_source": True,
                        "real_time": True,
...
def run_api_gateway(config: Dict, host: str = "0.0.0.0", port: int = 8000):
    ...
    print(f"🎯 Supporting all 8 question types from problem statement")
